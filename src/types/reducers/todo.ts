...
export type ChangeField = {
    id: number, fieldName: keyof TodoItem, fieldVal: any
}
...
//RootAction
export type TodoActions =  ILoadStateAction | IAddItemAction | IDeleteItemAction | IToggleDoneAction |
    IReplaceTodoItemsAction | IChangeFieldAction
